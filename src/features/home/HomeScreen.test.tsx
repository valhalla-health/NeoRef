...
// HomeScreen shows the signed-in user's name (useAuth) and a server-synced
// stats chip (useMyStats), so every render needs an AuthProvider and a
// stubbed fetch — same pattern as App.test.tsx.
beforeEach(() => {
