    ...
    <div style={{ width: '100%', height: '100%', background: warm.paper, overflowY: 'auto', overflowX: 'hidden' }}>
      <div style={{ padding: '16px 20px 8px' }}>
        <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between' }}>
          ...
          {user && <AccountButton name={user.name || user.email} onClick={() => setAccountOpen(true)} />}
        </div>
...
// Opens the account panel (AccountPanel.tsx), which holds both rename — the
// name shown here also drives the row label on the leaderboard
// (LeaderboardScreen.tsx) — and sign-out.
